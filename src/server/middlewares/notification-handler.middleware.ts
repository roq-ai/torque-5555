...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'reservation.create': {
    roles: ['reservation-manager', 'vehicle-owner'],
    key: 'new-vehicle-reservation',
  ...
  'reservation.delete': {
    roles: ['reservation-manager', 'customer'],
...
const tenantRoles: string[] = ['administrator', 'vehicle-owner', 'reservation-manager'];
