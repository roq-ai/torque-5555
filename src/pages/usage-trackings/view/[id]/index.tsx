...
import { getUsageTrackingById } from 'apiSdk/usage-trackings';
import { UsageTrackingInterface } from 'interfaces/usage-tracking';

function UsageTrackingViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('usage_tracking', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/usage-trackings/edit/${id}`} passHref legacyBehavior>
                    <Button
