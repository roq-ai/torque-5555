...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'vehicle-owner', 'reservation-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Usage Trackings',
      path: '/usage-trackings',
      entity: 'usage_tracking',
      service: AccessServiceEnum.PROJECT,
      icon: FiActivity,
    },
    { name: 'Vehicles', path: '/vehicles', entity: 'vehicle', service: AccessServiceEnum.PROJECT, icon: FiTruck },
